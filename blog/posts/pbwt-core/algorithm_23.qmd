...
- Algorithm 3 has a main role for identifying match blocks, while the Algorithm 2 manages divergence vectors and tracebacks to original haplotypes.  
- Algorithm 3 is remarkably efficient, running in $O(MN)$ time to find all match blocks (run through haplotypes once at each site). 
- This approach is widely used in genetic genealogy and population genetics to find shared ancestry and identify regions of the genome that are conserved within a population.
