...
![Algorithm 2 & 3: Finding all matches longer than a minimum length $L$](../../assets/algorithm_23.png){#fig-algorithm23}
...
- **Block 1**: At $k=2$, the divergence value $d[2] = 1$ satisfies the threshold ($1 \le 1$). This identifies a match between haplotypes at indices 1 and 2 in the sorted array (haplotypes 1 and 2).
